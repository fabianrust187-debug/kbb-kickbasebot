...
export async function runKbbHelp(interaction) {
  ...
  const embed = buildKbbEmbed({
    ...
    description: [
      ...
      "Live-Ereignisse werden semantisch zusammengeführt, damit aktualisierte ESPN-Datensätze nicht mehrfach gepostet werden.",
      "Für Torschützen, Vorlagengeber sowie Karten-/Verletzungsspieler wird der Besitzer über die vollständigen Kickbase-Managerkader ermittelt; anschließend wird der zugehörige Discord-Manager markiert, sofern die Namenszuordnung eindeutig ist.",
