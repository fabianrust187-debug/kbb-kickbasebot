...
export async function runKbbHelp(interaction) {
  ...
  const embed = buildKbbEmbed({
    ...
    description: [
      ...
      "Die Besitzerzuordnung nutzt Kickbase-Ranking + vollständige Manager-Kader aus dem Teamcenter; anschließend wird der zugehörige Discord-Manager markiert, sofern die Zuordnung eindeutig ist.",
