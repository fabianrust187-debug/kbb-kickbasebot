...
export async function runKbbHelp(interaction) {
  ...
  const embed = buildKbbEmbed({
    ...
    description: [
      ...
      "Neue Tore werden kurz gesammelt, damit Spielstand und Vorlagengeber vor der einmaligen Discord-Meldung vervollständigt werden können.",
      "Die Besitzerzuordnung ermittelt die Liga-Manager über Overview/Ranking und lädt anschließend deren vollständige Kickbase-Kader; danach wird der zugehörige Discord-Manager markiert, sofern die Zuordnung eindeutig ist.",
